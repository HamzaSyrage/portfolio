export default function Contact() {
  return (
    <section className="content-section sec-content contact-me-sec">
      <p className="subt">Contact me</p>
      <ul className="contact">
        <li>
          <a
            href="mailto:hamzasyrage@gmail.com"
            target="_blank"
            rel="My Personal Email"
          >
            <svg
              viewBox="0 -2.5 20 20"
              version="1.1"
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/hamza-syrage-82891431a"
            target="_blank"
        ...
        <li>
          <a
            href="https://m.facebook.com/hamza.seraji1/"
            target="_blank"
        ...
        <li>
          <a
            href="https://wa.me/qr/EEJTB46JXPRCG1"
            target="_blank"
            rel="My WhatsApp Account"
          >
            <svg
              fill="#cee6f7"
              viewBox="0 0 32 32"
        ...
        <li>
          <a
            href="https://t.me/HamzaSyrage"
            target="_blank"
            rel="My Telegram Account"
          >
            <svg
              viewBox="0 0 20 20"
              version="1.1"
